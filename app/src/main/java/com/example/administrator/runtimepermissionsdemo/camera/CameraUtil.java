 ...
 * @description: 摄像头工具类——SurfaceHolder
 */
public class CameraUtil {
    ...
    public CameraUtil(Context mContext, SurfaceView mSurfaceView) {
        this.mContext = mContext;
        this.mSurfaceView = mSurfaceView;
        mSurfaceHolder = mSurfaceView.getHolder();
        config(mContext, mSurfaceView, mSurfaceHolder);
    }

    /**
     * 配置mSurfaceView、mSurfaceHolder
     *
     * @param mContext
     * @param mSurfaceView
     * @param mSurfaceHolder
     */
    private void config(Context mContext, SurfaceView mSurfaceView, SurfaceHolder mSurfaceHolder) {
        mSurfaceView.setFocusable(true);

        mSurfaceHolder.setType(SurfaceHolder.SURFACE_TYPE_PUSH_BUFFERS);
        mSurfaceHolder.setKeepScreenOn(true);
        mSurfaceHolder.addCallback((SurfaceHolder.Callback) mContext);
    }
...
//            }
    ...
    public void close() {
        if (camera != null) {
            ...
            camera.cancelAutoFocus();
            mSurfaceHolder.removeCallback((SurfaceHolder.Callback) mContext);  //解决Camera is being used after Camera.release() was called
            if (isPreview) {
                camera.stopPreview();
                isPreview = false;
            }
